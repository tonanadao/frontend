...
const fetchMarkets = async (stu: Setter<number>, ssu: Setter<number>, sau: Setter<number>, snu: Setter<number>, sauruu: Setter<number>, susn: Setter<number>, sethu: Setter<number>, smaticu: Setter<number>) => {
