...
class NominatorPoolSource {
    ...
    static create(opts) {
        ...
        let initialCode = ton_1.Cell.fromBoc(NominatorPoolSource.SOURCE)[0];
    ...
    seed;
    owner;
    type = 'con.tonwhales.nominators.v1';
    constructor(args) {
...
exports.NominatorPoolSource = NominatorPoolSource;
